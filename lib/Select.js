   ...
   */
	...
	render: function render() {
		...
		if (this.props.searchable && !this.props.disabled) {
			input = React.createElement(Input, _extends({ value: this.state.inputValue, onChange: this.handleInputChange, minWidth: "5", placeholder: this.state.placeholder }, inputProps));
		} else {
